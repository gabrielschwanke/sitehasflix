#para criar as páginas do site têm que criar três coisas.
#url, o link onde aquela página vai aparecer
#view, código em python que vai dizer oque vai acontecer quando entrarem
#template, parte visual do site, arquivos em html
